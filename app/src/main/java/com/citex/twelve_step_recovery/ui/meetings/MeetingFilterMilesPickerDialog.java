...
public class MeetingFilterMilesPickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final String milesUnitValues[] = { "1", "3", "5", "10" };
        ...
        builder.setMessage("Select the miles distance filter:");
