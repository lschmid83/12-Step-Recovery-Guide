...
public class MeetingWorldwideFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(NetworkConnection.isNetworkAvailable(getActivity())) {
            ...
            webview.setWebViewClient(new MeetingWorldwideFragment.WebViewClient());
            ...
            // Load webpage.
            webview.loadUrl("https://aa-intergroup.org/meetings");
